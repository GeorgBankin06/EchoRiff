...
class RadiosActivity : AppCompatActivity() {
    ...
    private fun setupBottomNav() {
        ...
        binding.bottomNavigationView.setOnItemSelectedListener { item ->
            when (item.itemId) {
                R.id.nav_radios -> {
                    findNavController(R.id.radio_nav_host_fragment).navigate(R.id.radiosFragment)
                    true
                }

                R.id.nav_favorites -> {
                    findNavController(R.id.radio_nav_host_fragment).navigate(R.id.favoritesFragment)
                    true
                }
